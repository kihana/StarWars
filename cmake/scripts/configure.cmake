...
execute_process(
  COMMAND cmake ${CMAKE_SOURCE_DIR} -G "Visual Studio 17 2022"
          -DCMAKE_TOOLCHAIN_FILE=${CMAKE_SOURCE_DIR}/build/conan_toolchain.cmake -DCMAKE_POLICY_DEFAULT_CMP0091=NEW
